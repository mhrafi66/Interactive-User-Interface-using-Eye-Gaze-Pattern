...
def letter(letter_index,text,letter_light):
    ...
    if letter_light is True:
        cv2.rectangle(keyboard, (x + th, y + th), (x + width - th, y + width - th), (255, 255, 255), -1)
    else:
        cv2.rectangle(keyboard, (x+th,y+th),(x+width-th,y+width-th), (255,0,0),th)
...
while True:
    ...
    for face in faces:
        ...
        if gaze_ratio <= 0.7:
            ...
            if last_keyboard_selection == "center":
                letter_index += 1
                #right_sound.play()
                time.sleep(1)
                last_keyboard_selection = keyboard_select
        elif 0.5< gaze_ratio < 5:
            cv2.putText(frame, str(gaze_ratio), (50, 150), font, 2, (0, 0, 255), 3)
    ...
    cv2.putText(board,text,(10,150), font, 4, 0, 3)
